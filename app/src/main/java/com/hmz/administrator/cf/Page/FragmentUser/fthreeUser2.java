...
public class fthreeUser2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fthree_user);

        Intent intent = getIntent();

        a = intent.getStringExtra("img");
        Log.i("dchfsc", a);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(fthreeUser2.this, fthreeUser3.class);
