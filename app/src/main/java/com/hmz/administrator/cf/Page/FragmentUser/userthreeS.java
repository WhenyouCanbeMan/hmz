...
public class userthreeS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userthree_s); wView = findViewById(R.id.webView);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(userthreeS.this, FragmentThree.class);
        ...
        new Thread()
        {
            public void run()
            {
                try {
                    ...
                    HttpGet httpGet = new HttpGet("https://www.pku.edu.cn/");
