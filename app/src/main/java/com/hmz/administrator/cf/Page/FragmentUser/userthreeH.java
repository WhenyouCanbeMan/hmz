...
public class userthreeH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userthree_h);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(userthreeH.this, FragmentThree.class);
        ...
        new Thread()
        {
            public void run()
            {
                try {
                    ...
                    HttpGet httpGet = new HttpGet("https://baijiahao.baidu.com/s?id=1625329400052251812&wfr=spider&for=pc");
