...
import com.hmz.administrator.cf.utils.weather.gson.Forecast;
import com.hmz.administrator.cf.utils.weather.gson.Weather;
import com.hmz.administrator.cf.utils.weather.util.HttpUtil;
    ...
    public void requestWeather(final String weatherId) {
        ...
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.i("askjfhjashf",responseText);
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(WeatherActivity.this, "从网上获取天气信息失败", Toast.LENGTH_SHORT).show();
                        swipeRefresh.setRefreshing(false);
                    }
                });
            }
